...
namespace Shop.Persistence.EF.Migrations
{
    ...
    [Migration("20220908172145_Changed BasketCart on ShoppingCart")]
    partial class ChangedBasketCartonShoppingCart
    {
            ...
            modelBuilder.Entity("Shop.Domain.Entities.ShoppingCart", b =>
                {
                    b.HasOne("Shop.Domain.Entities.User", "User")
                        ...
                        .HasForeignKey("Shop.Domain.Entities.ShoppingCart", "UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
