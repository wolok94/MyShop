...
namespace Shop.Persistence.EF.Migrations
{
    ...
    [Migration("20220904165928_Changed name baskets on BasketCarts")]
    partial class ChangednamebasketsonBasketCarts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shop.Domain.Entities.Basket", b =>
                {
                    b.HasOne("Shop.Domain.Entities.User", "User")
                        .WithOne("Basket")
                        .HasForeignKey("Shop.Domain.Entities.Basket", "UserId")
            ...
            modelBuilder.Entity("Shop.Domain.Entities.OrderToSend", b =>
                {
                    b.HasOne("Shop.Domain.Entities.Basket", "Basket")
                        .WithMany()
                    ...
                    b.HasOne("Shop.Domain.Entities.Customer", "User")
                        .WithOne("Order")
                        .HasForeignKey("Shop.Domain.Entities.OrderToSend", "UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
